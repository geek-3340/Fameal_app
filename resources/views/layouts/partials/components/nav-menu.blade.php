<nav class="fixed z-40 top-0 left-0 flex flex-col w-48 h-screen mt-20 pt-8 pl-4 bg-white border border-r-main max-md:hidden"
    id="js-left-menu">
    <a href="{{ route('menus.index','dishes-month') }}" class="text-main text-xl font-bold block w-max px-2 py-1 mb-4">献立表</a>
...
<nav x-show="openNavMenu" x-cloak @click.away="openNavMenu = false" @keydown.escape.window="openNavMenu = false"
    ...
    <a href="{{ route('menus.index','dishes-month') }}" class="text-white text-xl font-bold mb-4">献立表</a>
