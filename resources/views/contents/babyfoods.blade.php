        ...
        <form action="{{ route('babyfoods.store') }}" method="POST">
            ...
            <div class="mb-4 flex justify-between">
                ...
                <label>
                    ...
                    <span
                        class="cursor-pointer px-4 py-1 rounded-xl border-2 border-customRed peer-checked:bg-customRed peer-checked:bg-opacity-50">
                        タンパク質
                    </span>
                </label>
                <label>
                    ...
                    <span
                        class="cursor-pointer px-4 py-1 rounded-xl border-2 border-customGreen peer-checked:bg-customGreen peer-checked:bg-opacity-50">
                        ビタミン
                    </span>
                </label>
                <label>
                    ...
                    <span
                        class="cursor-pointer px-4 py-1 rounded-xl border-2 border-gray-400 peer-checked:bg-gray-400 peer-checked:bg-opacity-50">
                        その他
                    </span>
                </label>
            </div>
